...
def parse_args():
    ...
    parser.add_argument('--dataset_path', default='/data/kyanchen/levircd', help='potsdam folder path')
    parser.add_argument('-o', '--out_dir', default='/data/kyanchen/levircd512', help='output path')
    parser.add_argument(
        '--clip_size',
        type=int,
