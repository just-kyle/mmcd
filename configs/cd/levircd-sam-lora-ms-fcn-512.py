import os
work_dir = './work_dirs/levircd/sam-lora-ms-fcn-512'
...
visualizer = dict(type='SegLocalVisualizer', vis_backends=vis_backends, name='visualizer', save_dir=work_dir)
...
default_hooks = dict(
    ...
    visualization=dict(type='SegVisualizationHook', draw=True, interval=1, alpha=0.8)
)