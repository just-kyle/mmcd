...
work_dir = './work_dirs/bx/whu-samdecoder-512'

vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='bx', name=os.path.basename(work_dir)))
                ]
visualizer = dict(
